...
USER_NAME = os.environ['USER_NAME'] # 'leonamvasquez'
...
def simple_request(func_name, query, variables):
    ...
    for attempt in range(5):
        ...
        if request.status_code in (502, 503, 504):
            time.sleep(2 ** attempt)  # exponential backoff on GitHub's transient gateway errors
            continue
        break
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2000, 11, 5))
